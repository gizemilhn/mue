...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <form method="GET" class="flex flex-col md:flex-row flex-wrap gap-4 items-end">
            ...
            <div class="flex-1 min-w-40">
                <label class="block text-sm font-medium text-gray-700 mb-1">Kullanıcı veya Kod Ara</label>
                <input type="text" name="user_search"
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                       placeholder="Ad, e-posta veya iade kodu..."
            ...
            <div class="flex space-x-2">
                ...
                @if(request()->hasAny(['status', 'user_search', 'start_date', 'end_date']))
